...
<button type="button" class="btn btn-info"><a href="galley3.php">Vegetables</a></button>

<!-- Contextual button for informational alert messages -->
<button type="button" class="btn btn-info"><a href="galley3.php">Fruits & Nuts</a></button>

 
<!-- Indicates a dangerous or potentially negative action -->
<button type="button" class="btn btn-default"><a href="Contact.php">contact</a></button>
