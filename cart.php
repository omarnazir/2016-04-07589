...
<body class="container">
  ...
  <div class="row">
    <div class="col-md-3 text-center">
      <img src="images/seeds.jpg" width="150px" height="150px">
      <br>
      coconuts 1 - <strong>$10</strong>
      <br>
    ...
    <div class="col-md-3 text-center">
      <img src="images/cooo.png" width="150px" height="150px">
      <br>
      Vegetables 2 - <strong>$20</strong>
      <br>
    ...
    <div class="col-md-3 text-center">
      <img src="images/front.jpg" width="150px" height="150px">
      <br>
      fruits 3 - <strong>$30</strong>
      <br>
    ...
    <div class="col-md-3 text-center">
      <img src="images/mbolea.jpg" width="150px" height="150px">
      <br>
      compost 4 - <strong>$40</strong>
      <br>
    ...
    <div class="col-md-3 text-center">
      <img src="images/cow2.jpg" width="150px" height="150px">
      <br>
      cow 5 - <strong>$50</strong>
      <br>
      ...
      <a href="#" class="btn btn-info"><a href="page.php">Details</a>
    </div>
...
<button type="button" class="btn btn-info" align ="center"><a href="Contact.php"><a href="Contact.php">Tigo-Pesa </a></a></button>

<!-- Indicates a successful or positive action -->
<button type="button" class="btn btn-success" align ="center"><a href="Contact.php"><a href="Contact.php">M-PESA </a></button>

<!-- Contextual button for informational alert messages -->
<button type="button" class="btn btn-info" align ="center"><a href="Contact.php"><a href="Contact.php">AIRTEL MONEY </a></button>
</div>
